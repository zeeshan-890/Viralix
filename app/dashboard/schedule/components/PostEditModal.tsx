            ...
            <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            defaultValue="Morning Motivation Video"
                    ...
                    <div>
                        ...
                        <textarea
                            rows={4}
                            defaultValue="Start your day with positive energy! 🌅 Here are 3 simple tips to boost your morning motivation... #motivation #morningvibes #productivity"
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                ...
                                <label key={platform.id} className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                    <input
                                        type="checkbox"
