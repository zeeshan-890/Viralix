...
export default function PlatformConnections() {
    ...
    const toggleConnection = (index) => {
        setConnections(prev => prev.map((conn, i) => i === index ? Object.assign(Object.assign({}, conn), { connected: !conn.connected }) : conn));
    };
    return (<div id="platforms" className="bg-white rounded-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Platform Connections</h3>

            <div className="space-y-4">
                {connections.map((connection, index) => (<div key={connection.platform} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                ...
                : 'Not connected'}
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <button onClick={() => toggleConnection(index)} className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${connection.connected
            ...
            <div className="mt-6 border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="flex">
                            <input type="password" value="sk-xxxxxxxxxxxxxxxxxxxxxxxx" readOnly className="flex-1 px-3 py-2 border border-gray-300 rounded-l-lg bg-gray-50"/>
