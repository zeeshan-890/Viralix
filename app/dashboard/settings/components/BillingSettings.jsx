export default function BillingSettings() {
    return (<div id="billing" className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="email" defaultValue="billing@company.com" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                Company Name
                            </label>
                            <input type="text" defaultValue="Acme Corp" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
                        </div>
                    </div>
                </div>
        ...
        ].map((payment, index) => (<div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
