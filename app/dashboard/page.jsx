...
export default function DashboardPage() {
    return (<div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <StatsCard title="Total Views" value="2.4M" change={12} icon="👁️" color="blue"/>
                <StatsCard title="Engagement Rate" value="4.8%" change={8} icon="❤️" color="green"/>
                <StatsCard title="Posts This Month" value="24" change={-5} icon="📝" color="purple"/>
                <StatsCard title="Scheduled Posts" value="12" icon="📅" color="blue"/>
            </div>
