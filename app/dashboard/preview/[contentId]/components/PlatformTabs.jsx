...
export default function PlatformTabs({ contentId }) {
    ...
    const renderPreview = () => {
        switch (activeTab) {
            case 'tiktok':
                return (<div className="bg-black rounded-lg aspect-[9/16] max-w-sm mx-auto relative overflow-hidden">
            ...
            case 'youtube':
                return (<div className="bg-black rounded-lg aspect-video relative overflow-hidden">
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-white text-center">
            ...
            case 'instagram':
                return (<div className="bg-white rounded-lg border border-gray-200 max-w-md mx-auto">
                        {/* Instagram Header */}
            ...
            case 'linkedin':
                return (<div className="bg-white rounded-lg border border-gray-200 max-w-lg mx-auto">
                        {/* LinkedIn Header */}
    ...
    return (<div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="flex space-x-1 mb-6 bg-gray-100 rounded-lg p-1">
                {platforms.map((platform) => (<button key={platform.id} onClick={() => setActiveTab(platform.id)} className={`flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-md transition-colors ${activeTab === platform.id
