export const metadata = {
    title: 'Terms of Service | AutoReach',
    description: 'Terms governing the use of AutoReach platform.'
};
...
export default function TermsPage() {
    return (
        <main className="mx-auto max-w-4xl px-6 py-12 prose prose-slate dark:prose-invert">
            ...
            <p>These Terms of Service ("Terms") form a binding agreement between you ("User" or "you") and <strong>AutoReach</strong> ("AutoReach", "we", "our"). By accessing or using the platform you agree to these Terms. If you do not agree, do not use the service.</p>

            <h2>1. Service Description</h2>
            <p>AutoReach provides tools to draft, schedule, publish, and analyze social media content, and to generate AI-assisted captions/hashtags.</p>
            ...
            <p>You retain ownership of content you supply. You grant AutoReach a worldwide, non-exclusive license to host, process, transform, and transmit content solely to operate and improve the service.</p>
            ...
            <p>The platform, code, design, and trademarks are owned by AutoReach or licensors. No rights are granted except as explicitly stated.</p>
            ...
            <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, AUTO REACH IS NOT LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR LOST PROFITS, EVEN IF ADVISED OF POSSIBILITY. AGGREGATE LIABILITY SHALL NOT EXCEED FEES PAID (IF ANY) IN THE PRECEDING 3 MONTHS.</p>

            <h2>14. Indemnity</h2>
            <p>You agree to indemnify and hold harmless AutoReach from claims arising from your content, misuse, or violation of these Terms.</p>
            ...
            <p>Unless required otherwise by local law, these Terms are governed by the laws applicable where AutoReach is primarily operated (to be specified by your business jurisdiction).</p>

            <h2>17. Contact</h2>
            <p>Questions: <a href="mailto:legal@autoreach.ai">legal@autoreach.ai</a></p>
