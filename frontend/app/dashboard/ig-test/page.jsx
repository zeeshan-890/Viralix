...
import { igTestAPI, uploadAPI } from '@/lib/api';
...
export default function IgTestPage() {
    ...
    // Uploaded media: array of { url, type, altText }
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-[var(--viralix-accent)]">Instagram Publishing Test</h1>
                        <p className="text-gray-600">Isolated sandbox — Instagram Login only, no Facebook Page</p>
                    </div>
                </div>
            </div>
            ...
            <div className="dash-card dash-card-hover rounded-xl border border-[var(--viralix-border)] p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-semibold text-[var(--viralix-accent)]">Test Accounts</h2>
                ...
                {loadingAccounts ? (
                    ...
                    <p className="text-sm text-gray-500 mb-4">No test accounts connected yet.</p>
                ) : (
